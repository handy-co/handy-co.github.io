...
/******/ 	var hotCurrentHash = "1156102d4fc5882cd52c"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _words = __webpack_require__(174);

	var _App = __webpack_require__(177);

	var _App2 = _interopRequireDefault(_App);

	var _handy = __webpack_require__(243);

	var _handy2 = _interopRequireDefault(_handy);
	...
	var words = _store$getState.words;


	if (words.length === 0) {
	  store.dispatch((0, _words.load)());
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports =  false ? require("./store.dev") : __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  return (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default))(_redux.createStore)(_index2.default);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _current = __webpack_require__(176);
	...
	exports.default = (0, _redux.combineReducers)({ loading: _loading2.default, words: _words2.default, current: _current2.default });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function main() {
	  ...
	  switch (action.type) {
	    ...
	    case OPEN:
	      return state.map(function (word, n) {
	        return _extends({}, word, { open: n === action.current || word.open });
	      });
	...
	function load() {
	  return function (dispatch) {
	    dispatch((0, _loading.increment)());

	    return get("/words.json").then(function (words) {
	      return dispatch(receiveWords(words.map(function (word) {
	        return { word: word[0], ipa: word[1], translations: [word[2]], open: false };
	      })));
	    }).then(function () {
	      return dispatch((0, _loading.decrement)());
	    });
	  };
	}

	function open(current) {
	  return { type: OPEN, current: current };
	}
...
/***/ function(module, exports) {
	...
	var INCREMENT = "loading/increment";
	var DECREMENT = "loading/decrement";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports =  false ? require("./App.dev.jsx") : __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Handy = __webpack_require__(190);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        { store: store },
	        _react2.default.createElement(_Handy2.default, null)
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isHostObject = __webpack_require__(186),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactHotkeys = __webpack_require__(191);

	var _words = __webpack_require__(174);

	var _current = __webpack_require__(176);

	var _Word = __webpack_require__(238);
	...
	var Handy = function (_React$Component) {
	  _inherits(Handy, _React$Component);

	  function Handy() {
	    _classCallCheck(this, Handy);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Handy).apply(this, arguments));
	  }
	  ...
	  _createClass(Handy, [{
	    ...
	    value: function render() {
	      ...
	      var handlers = {
	        "left": function left() {
	          return current > 0 && dispatch((0, _current.prev)());
	        },
	        "right": function right() {
	          return current < words.length - 1 && dispatch((0, _current.next)());
	        },
	        "open": function open() {
	          return dispatch((0, _words.open)(current));
	        }
	      };
	      ...
	      return _react2.default.createElement(
	        ...
	        loading > 0 && _react2.default.createElement(_Loading2.default, null),
	        _react2.default.createElement(
	          "div",
	          { className: "handy-layout" },
	          words.slice(current, current + 1).map(function (word) {
	            return _react2.default.createElement(_Word2.default, _extends({ key: word }, word, touchHandlers));
	          }),
	          _react2.default.createElement(_Counter2.default, { current: current + 1, total: words.length })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HotKeys = __webpack_require__(192);
	...
	var _HotKeyMapMixin = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashLangIsBoolean = __webpack_require__(227);

	var _lodashLangIsBoolean2 = _interopRequireDefault(_lodashLangIsBoolean);

	var _lodashLangIsArray = __webpack_require__(209);

	var _lodashLangIsArray2 = _interopRequireDefault(_lodashLangIsArray);

	var _lodashLangIsObject = __webpack_require__(201);

	var _lodashLangIsObject2 = _interopRequireDefault(_lodashLangIsObject);

	var _lodashCollectionForEach = __webpack_require__(228);

	var _lodashCollectionForEach2 = _interopRequireDefault(_lodashCollectionForEach);

	var _lodashLangIsEqual = __webpack_require__(219);
	...
	var HotKeys = _react2['default'].createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    var Mousetrap = __webpack_require__(237);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashObjectAssign = __webpack_require__(195);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assignWith = __webpack_require__(196),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bindCallback = __webpack_require__(215),
	    isIterateeCall = __webpack_require__(217),
	    restParam = __webpack_require__(218);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var equalArrays = __webpack_require__(222),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isLength = __webpack_require__(206),
	    isObjectLike = __webpack_require__(202);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isObjectLike = __webpack_require__(202);
	  ...
	  _createClass(Word, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        { onTap: onTap, onSwipe: function onSwipe(event) {
	            return event.velocityX > 0 ? onSwipeLeft() : onSwipeRight();
	          } },
	        _react2.default.createElement(
	          "ul",
	          { className: "handy-word", onMouseEnter: function onMouseEnter(e) {
	              return _this2.handleMouseEnter();
	            } },
	          _react2.default.createElement(
	            "li",
	            { className: ["handy-word-item", "_ipa", open ? "" : "_hidden"].join(" ") },
	            ipa
	          ),
	          _react2.default.createElement(
	            "li",
	            { className: ["handy-word-item", "_word"].join(" ") },
	            word
	          ),
	          _react2.default.createElement(
	            "li",
	            { className: ["handy-word-item", "_tr", open ? "" : "_hidden"].join(" ") },
	            translations[0]
	          )
	        )
	      );
