...
/******/ 	var hotCurrentHash = "12615a5a6b2e928cac72"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _handy = __webpack_require__(232);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function configure() {
	  return (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default))(_redux.createStore)(_reducer2.default);
	}
...
/***/ function(module, exports) {
	...
	exports.next = next;
	exports.prev = prev;
	var words = [["cosy", "[ˈkəʊzɪ]", "уютный"], ["throughout", "[θruːˈaʊt]", "через, везде"], ["consecutive", "[kənˈsɛkjʊtɪv]", "последовательный"], ["sequential", "[sɪˈkwɛnʃ(ə)l]", "следующий"]];

	var PREV = "prev";
	var NEXT = "next";

	function main() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? { words: words, current: 0 } : arguments[0];
	  ...
	  return (function () {
	    ...
	    switch (action.type) {
	      case NEXT:
	        return _extends({}, state, { current: current + 1 < words.length && current + 1 || words.length - 1 });
	      case PREV:
	        return _extends({}, state, { current: current > 0 && current - 1 || 0 });
	      default:
	        return state;
	    }
	  })();
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports =  false ? require("./App.dev.jsx") : __webpack_require__(174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactHotkeys = __webpack_require__(185);
	...
	var Hello = (function (_React$Component) {
	  ...
	  _createClass(Hello, [{
	    ...
	    value: function render() {
	      ...
	      var word = this.props.words[this.props.current];
	      ...
	      var handlers = {
	        "left": function left(event) {
	          return dispatch((0, _reducer.prev)());
	        },
	        "right": function right(event) {
	          return dispatch((0, _reducer.next)());
	        }
	      };
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "div",
	          { className: "cosy-layout" },
	          _react2.default.createElement(
	            "ul",
	            { className: "cosy-word", onMouseEnter: function onMouseEnter(e) {
	                return _this2.handleMouseEnter(e);
	              } },
	            _react2.default.createElement(
	              "li",
	              { className: "cosy-word-item _apa" },
	              word[1]
	            ),
	            _react2.default.createElement(
	              "li",
	              { className: "cosy-word-item _word" },
	              word[0]
	            ),
	            _react2.default.createElement(
	              "li",
	              { className: "cosy-word-item _tr" },
	              word[2]
	            )
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HotKeys = __webpack_require__(186);

	exports.HotKeys = _interopRequire(_HotKeys);

	var _FocusTrap = __webpack_require__(187);

	exports.FocusTrap = _interopRequire(_FocusTrap);

	var _HotKeyMapMixin = __webpack_require__(188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashLangIsBoolean = __webpack_require__(221);

	var _lodashLangIsBoolean2 = _interopRequireDefault(_lodashLangIsBoolean);

	var _lodashLangIsArray = __webpack_require__(203);

	var _lodashLangIsArray2 = _interopRequireDefault(_lodashLangIsArray);

	var _lodashLangIsObject = __webpack_require__(195);

	var _lodashLangIsObject2 = _interopRequireDefault(_lodashLangIsObject);

	var _lodashCollectionForEach = __webpack_require__(222);

	var _lodashCollectionForEach2 = _interopRequireDefault(_lodashCollectionForEach);

	var _lodashLangIsEqual = __webpack_require__(213);
	...
	var HotKeys = _react2['default'].createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    var Mousetrap = __webpack_require__(231);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashObjectAssign = __webpack_require__(189);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var assignWith = __webpack_require__(190),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNative = __webpack_require__(192),
	    ...
	    shimKeys = __webpack_require__(201);
